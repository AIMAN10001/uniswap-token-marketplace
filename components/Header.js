...
const Header = () => {
  ...
  return (
    <header className="p-3 text-gray-100">
          ...
          <ul className=" items-stretch hidden space-x-3 lg:flex">
            <li className=" flex">
              <a
                rel="noopener noreferrer"
                href="/"
                className="flex items-center px-4 -mb-1 dark:border-transparent font-semibold hover:underline text-[#FC4A1A] border-[#FC4A1A]"
              >
                Swap
              </a>
            </li>
            <li className=" flex">
              <a
                rel="noopener noreferrer"
                href="/tokens"
                className="flex items-center px-4 -mb-1 hover:underline dark:border-transparent"
              >
                Tokens
              </a>
            </li>
