...
const SwapComponent = () => {
  ...
  useEffect(() => {
    // handling text of the submit button
  ...
  return (
    <div className=" border-[1px] rounded-l border-[#FC4A1A] bg-[#FC4A1A] w-[100%] p-4 px-6 rounded-xl">
  ...
  function getSwapBtnClassName() {
    ...
    className +=
      swapBtnText === ENTER_AMOUNT || swapBtnText === CONNECT_WALLET
        ? " text-zinc-300 bg-zinc-800 pointer-events-none"
        : " bg-[#FCB733]";
    className += swapBtnText === INCREASE_ALLOWANCE ? " bg-[#4ABDAC]" : "";
    return className;
  }
