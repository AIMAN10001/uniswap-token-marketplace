...
const SingleCard = ({ index, name, walletAddress }) => {
  ...
  return (
    <article
      className={`flex flex-col bg-[#3ca999ee] rounded  ${styles.hoverScale}`}
    >
      <a
        rel="noopener noreferrer"
        href="#"
        aria-label="Te nulla oportere reprimique dolorum"
      >
        <img
          alt=""
          className=" object-cover w-full h-62 rounded bg-gray-500"
          src={`img/${index + 1}.png`}
        />
      </a>
      <div className=" flex flex-col flex-1 p-6">
        <a
          rel="noopener noreferrer"
          href="#"
          aria-label="Te nulla oprtere reprimique his dolorum"
        ></a>
        <a
          rel="noopener noreferrer"
          href="#"
          className=" text-xs tracki uppercase hover:underline font-semibold text-[#FC4A1A]"
        >
          {name} 10 M Supply
        </a>
        ...
        <div className=" flex mx-2 pt-[10px]">
          ...
          <div className=" flex items-center p-2 px-2 bg-[#FCB733] rounded-r-lg">
            <copyIcon.icon
